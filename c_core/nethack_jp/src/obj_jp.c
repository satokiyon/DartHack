...
const char *const obj_jp_names[NUM_OBJECTS + 1] = {
    ...
    [C_RATION] = "Ｃレーション",
    [CAN_OF_GREASE] = "脂の缶",
    [CANDELABRUM_OF_INVOCATION] = "祈りの燭台",
    [CANDY_BAR] = "キャンディバー",
    [CARROT] = "にんじん",
    [CHAIN_MAIL] = "鎖かたびら",
    [CHEST] = "宝箱",
    ...
    [FAKE_AMULET_OF_YENDOR] = "イェンダーの魔除けの模造品",
    [FAUCHARD] = "フォシャール",
    [FEDORA] = "フィドーラ",
    [FIGURINE] = "人形",
    [FIRE_HORN] = "炎のホルン",
...
const char *const obj_jp_descrs[NUM_OBJECTS + 1] = {
    ...
    [ELVEN_SPEAR] = "神秘的な槍",
    [EMERALD] = "緑の石",
    [FAKE_AMULET_OF_YENDOR] = "イェンダーの魔除け",
    [FAUCHARD] = "鎌付き竿",
    [FIRE_HORN] = "ホルン",
    [FLINT] = "灰色の宝石",
    [FLUORITE] = "紫の石",
    ...
    [SC05] = "「リグ・ヴェーダ」と書かれた巻物",
    [SC06] = "「ウパニシャッド」と書かれた巻物",
    [SC07] = "「ピカトリクス」と書かれた巻物",
    ...
    [SCR_CREATE_MONSTER] = "「エヌマ・エリシュ」と書かれた巻物",
    [SCR_DESTROY_ARMOR] = "「コデックス・ボルジア」と書かれた巻物",
    [SCR_EARTH] = "「チラン・バラン」と書かれた巻物",
    [SCR_ENCHANT_ARMOR] = "「モージャノ・タワムレ」と書かれた巻物",
    [SCR_ENCHANT_WEAPON] = "「レメゲトン」と書かれた巻物",
    ...
    [SCR_MAGIC_MAPPING] = "「アヴェスター」と書かれた巻物",
    [SCR_MAIL] = "消印の押された巻物",
    [SCR_PUNISHMENT] = "「アイガカリ・コシカケギン」と書かれた巻物",
    [SCR_REMOVE_CURSE] = "「ニガシムジャウム」と書かれた巻物",
    [SCR_SCARE_MONSTER] = "「クシクサ・クスクサ」と書かれた巻物",
    [SCR_STINKING_CLOUD] = "「ポポル・ヴフ」と書かれた巻物",
