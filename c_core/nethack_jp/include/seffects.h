...
#define seffect(basename) \
    ...
    /* 戦闘用効果音 (Combat Sound Effects) */
    seffect(combat_hit_slash),
    seffect(combat_hit_blunt),
    seffect(combat_hit_pierce),
    seffect(combat_hit_unarmed),
    seffect(combat_hit_whip),
    seffect(combat_hit_ironball),
    seffect(combat_hit_shield),
    seffect(combat_hit_corpse),
    seffect(combat_hit_pick),
    seffect(combat_hit_wand),
    seffect(combat_hit_other),
    seffect(combat_miss),
    seffect(combat_shoot_bow),
    seffect(combat_shoot_crossbow),
    seffect(combat_shoot_sling),
    seffect(combat_throw),
    seffect(combat_throw_boomerang),
    seffect(combat_throw_mjollnir),
    seffect(combat_miss_thud),
    seffect(combat_spell_cast),
    seffect(combat_wand_zap),
    seffect(mon_claw),
    seffect(mon_bite),
    seffect(mon_kick),
    seffect(mon_sting),
