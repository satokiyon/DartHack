...
extern const char *status_field_label_for_display(int);
...
extern const char *invlet_class_name_key(char);
...
extern const char *jp_mbodypart(struct monst *, int) NONNULLARG1;
extern const char *jp_body_part(int);
extern const char *jp_mbodypart_plural(struct monst *, int) NONNULLARG1;
extern const char *jp_body_part_plural(int);
...
extern const char *jp_a_gname_for_display(void);
extern const char *a_gname_at(coordxy x, coordxy y);
extern const char *jp_a_gname_at_for_display(coordxy x, coordxy y);
...
extern const char *jp_race_adj_for_display(int);
extern const char *jp_gender_for_display(int);
extern const char *jp_align_for_display(int);
...
extern const char * jp_trapname_for_display(int, boolean);
...
extern void flutter_check_new_level_rest(void);
