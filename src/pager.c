...
static const char *const jp_cmap_names[MAXPCHARS] = {
    ...
    [S_bear_trap] = "トラバサミ",
    [S_land_mine] = "地雷",
    [S_rolling_boulder_trap] = "転がる大岩の罠",
    [S_sleeping_gas_trap] = "睡眠ガスの罠",
    [S_rust_trap] = "錆の罠",
    [S_fire_trap] = "火炎の罠",
    [S_pit] = "落とし穴",
    [S_spiked_pit] = "串刺し落とし穴",
    [S_hole] = "穴",
    [S_trap_door] = "落とし戸",
    [S_teleportation_trap] = "テレポートの罠",
    [S_level_teleporter] = "レベルテレポートの罠",
    [S_magic_portal] = "魔法のポータル",
    [S_web] = "クモの巣",
    [S_statue_trap] = "彫像の罠",
    [S_magic_trap] = "魔法の罠",
    [S_anti_magic_trap] = "反魔法の罠",
    [S_polymorph_trap] = "変身の罠",
    [S_vibrating_square] = "震える床",
    [S_trapped_door] = "罠の仕掛けられた扉",
    [S_trapped_chest] = "罠の仕掛けられた宝箱",
    [S_vbeam] = "垂直のビーム",
    [S_hbeam] = "水平のビーム",
    [S_lslant] = "左斜めのビーム",
    [S_rslant] = "右斜めのビーム",
...
jp_translate_screen_desc(char *buf)
{
    static const struct {
        ...
        { "useful item (pick-axe, key, lamp...)", "useful item (pick-axe, key, lamp...) (便利な道具（つるはし、鍵、ランプなど）)" },
        { "suit or piece of armor", "suit or piece of armor (鎧または防具)" },
        { "splash of venom", "splash of venom (毒液の飛沫)" },
        { "pile of coins", "pile of coins (硬貨の山)" },
        { "gem or rock", "gem or rock (宝石または石)" },
        { "strange object", "strange object (奇妙な物体)" },
        { "illegal objects", "illegal objects (不正な物体)" },
        { "spellbook", "spellbook (魔法書)" },
        { "piece of food", "piece of food (食べ物)" },
        { "boulder", "boulder (巨大な岩)" },
        { "statue", "statue (像)" },
        { "weapon", "weapon (武器)" },
        { "ring", "ring (指輪)" },
        { "amulet", "amulet (護符)" },
        ...
        { "scroll", "scroll (巻物)" },
        { "wand", "wand (杖)" },
        { "iron ball", "iron ball (鉄球)" },
        { "iron chain", "iron chain (鉄鎖)" },
        { "ant or other insect", "ant or other insect (アリなどの昆虫)" },
        { "dog or other canine", "dog or other canine (犬などのイヌ科)" },
        { "eye or sphere", "eye or sphere (目玉や球体)" },
        { "cat or other feline", "cat or other feline (猫などのネコ科)" },
        { "imp or minor demon", "imp or minor demon (インプや下級デーモン)" },
        { "trapper or lurker above", "trapper or lurker above (トラッパーや天井潜み)" },
        { "unicorn or horse", "unicorn or horse (ユニコーンや馬)" },
        { "xan or other mythical/fantastic insect", "xan or other mythical/fantastic insect (ザンなどの幻想昆虫)" },
        { "angelic being", "angelic being (天使的存在)" },
        { "bat or bird", "bat or bird (コウモリや鳥)" },
        { "giant humanoid", "giant humanoid (大型の人型生物)" },
        { "invisible monster", "invisible monster (姿の見えない怪物)" },
        { "rust monster or disenchanter", "rust monster or disenchanter (さびモンスターや魔力剥ぎ)" },
        { "pudding or ooze", "pudding or ooze (プリンや粘液体)" },
        { "quantum mechanic", "quantum mechanic (量子メカニック)" },
        { "apelike creature", "apelike creature (類人猿系の生物)" },
        { "human or elf", "human or elf (人間またはエルフ)" },
        { "long worm tail", "long worm tail (ロングワームの尾)" },
        { "major demon", "major demon (上級デーモン)" },
        { "sea monster", "sea monster (海の怪物)" },
        { "Keystone Kop", "Keystone Kop (キーストーン・コップ)" },
        { "kobold", "kobold (コボルド)" },
        { "leprechaun", "leprechaun (レプラコーン)" },
        { "mimic", "mimic (ミミック)" },
        { "nymph", "nymph (ニンフ)" },
        { "orc", "orc (オーク)" },
        { "piercer", "piercer (ピアサー)" },
        { "quadruped", "quadruped (四足獣)" },
        { "rodent", "rodent (げっ歯類)" },
        { "vortex", "vortex (渦)" },
        { "worm", "worm (ワーム)" },
        { "zruty", "zruty (ズルティ)" },
        { "centaur", "centaur (ケンタウロス)" },
        { "dragon", "dragon (ドラゴン)" },
        { "elemental", "elemental (エレメンタル)" },
        { "fungus or mold", "fungus or mold (菌類やカビ)" },
        { "gnome", "gnome (ノーム)" },
        { "jabberwock", "jabberwock (ジャバウォック)" },
        { "lich", "lich (リッチ)" },
        { "mummy", "mummy (ミイラ)" },
        { "naga", "naga (ナーガ)" },
        { "ogre", "ogre (オーガ)" },
        { "snake", "snake (ヘビ)" },
        { "troll", "troll (トロル)" },
        { "umber hulk", "umber hulk (アンバー・ハルク)" },
        { "vampire", "vampire (吸血鬼)" },
        { "wraith", "wraith (レイス)" },
        { "xorn", "xorn (ゾーン)" },
        { "zombie", "zombie (ゾンビ)" },
        ...
        { "golem", "golem (ゴーレム)" },
        { "lizard", "lizard (トカゲ)" },
        { "arachnid or centipede", "arachnid or centipede (クモ類やムカデ)" },
        ...
        { "blob", "blob (ブロブ)" },
        { "boulder or statue", "boulder or statue (巨大な岩または像)" },
        { "cockatrice", "cockatrice (コカトリス)" },
        { "gremlin", "gremlin (グレムリン)" },
...
self_lookat(char *outbuf)
{
    ...
    race[0] = '\0';
    if (!Upolyd)
        Sprintf(race, "%sの", jp_current_race_adj());
